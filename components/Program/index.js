    ...
    <div id={id} className="flex justify-around py-[100px] items-center">
      ...
      <div>
        ...
        <div className="flex">
          <div 
            onClick={() => {
              Router.replace('/LiveSession')
            }}
          className="border-2 rounded-[30px] mt-4 mr-4 px-4 py-1 cursor-pointer bg-gradient-to-r from-cyan-500 to-blue-500 transition-all 250ms ease-in-out hover:scale-110">
            {link}
          </div>
        </div>
      </div>
